...
describe('Scoring', function()
  ...
  it('determines if O was the winner', function()
    ...
    board:set(2, "O")
    board:set(3, "O")
    assert.are.same(scoring:winning_mark(), "O")
  end)

  it('determines if X was the winner', function()
    set_board_state(3)
    assert.are.same(scoring:winning_mark(), "X")
  end)
